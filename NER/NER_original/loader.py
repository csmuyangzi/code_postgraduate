...
def load_data(params, tag_to_id):
    ...
    train_data = prepare_data(train_file, word_to_id,
                              tag_to_id, params.word_max_len)
    dev_data = prepare_data(dev_file, word_to_id,
                            tag_to_id, params.word_max_len)
    test_data = prepare_data(test_file, word_to_id,
                             tag_to_id, params.word_max_len)
